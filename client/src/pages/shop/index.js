...
import {shopPricedMembershipAndProductsData} from '../../utils/ShoppingUtils';

const Shop = ({data, location}) => {

    const {memberships, products, priceFromId} = shopPricedMembershipAndProductsData(data.shopProducts, data.shopMembership, data.allStripeProductIds);
